...
function Cgu(props) {
    return (
        <div className="ConditionsUtilisateur">
            <h2>Conditions générales d'utilisation</h2>
            <p>En vigueur au 01/04/2025
                ...
                https://cafthe.mathieu.houbron.dev-campus.fr/ se réserve le droit de modifier unilatéralement et à tout
                moment le contenu des présentes CGU.</p>
            <h3>Article 1 : Les mentions légales</h3>
            <p>L’édition et la direction de la publication du site https://cafthe.mathieu.houbron.dev-campus.fr/ est
                assurée par Mathieu HOUBRON, domicilié 3 rue des Pins 41700 CONTRES.
                Numéro de téléphone est 0613261122
                Adresse e-mail mathieu.houbron@campus-centre.fr.
                L'hébergeur du site https://cafthe.mathieu.houbron.dev-campus.fr/ est la société PLESK, dont le siège
                social est situé au Schaffhausen, SH.
            </p>
            <h3>ARTICLE 2 : Accès au site</h3>
            <p>Le site https://cafthe.mathieu.houbron.dev-campus.fr/ permet à l'Utilisateur un accès gratuit aux
                services suivants :
                Le site internet propose les services suivants :
                Vente fictive de café et de thé
                ...
                pas la responsabilité de https://cafthe.mathieu.houbron.dev-campus.fr/. Dans ces cas, l’Utilisateur
            ...
            <p>Les sources des informations diffusées sur le site https://cafthe.mathieu.houbron.dev-campus.fr/ sont
                ...
                Malgré des mises à jour régulières, le site https://cafthe.mathieu.houbron.dev-campus.fr/ ne peut être
                ...
                Le site https://cafthe.mathieu.houbron.dev-campus.fr/ ne peut être tenu pour responsable d’éventuels
            ...
            <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces
                liens, il sortira du site https://cafthe.mathieu.houbron.dev-campus.fr/. Ce dernier n’a pas de contrôle
                sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable
                de leur contenu.
            </p>
            ...
            <p>L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer automatiquement
                ...
                https://cafthe.mathieu.houbron.dev-campus.fr/. Les cookies ne contiennent pas d’information
                personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant
                unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de
                l’Utilisateur, d’autres restent.
                L’information contenue dans les cookies est utilisée pour améliorer le site
                https://cafthe.mathieu.houbron.dev-campus.fr/.
