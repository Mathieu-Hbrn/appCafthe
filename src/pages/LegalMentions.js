...
function LegalMentions(props) {
    return (
        <div className="MentionsLegales">
            ...
            https://cafthe.mathieu.houbron.dev-campus.fr/ , ci-après le "Site", les présentes mentions légales.
            ...
            <p>L’édition et la direction de la publication du Site est assurée par Monsieur Mathieu HOUBRON,
                domicilié 3 rue des Pins 41700 CONTRES, dont le numéro de téléphone est 0613261122, et
                l'adresse e-mail mathieu.houbron@campus-centre.fr.
                ci-après l'"Editeur".</p>
            <h2>HEBERGEUR</h2>
            <p>L'hébergeur du Site est la société PLESK, dont le siège social est situé au Schaffhausen, SH . </p>
            <h2>ACCES AU SITE</h2>
            <p>Le Site est normalement accessible, à tout moment, à l'Utilisateur. Toutefois, l'Editeur pourra, à tout
                ...
                conséquences éventuelles de cette indisponibilité sur les activités de l'Utilisateur.</p>
            <h2>COLLECTE DES DONNEES</h2>
            <p>Le Site assure à l'Utilisateur une collecte et un traitement des données personnelles dans le respect
                ...
                ses données personnelles. L'Utilisateur peut exercer ce droit depuis son espace personnel
            </p>
